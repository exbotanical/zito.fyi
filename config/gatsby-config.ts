...
const gatsbyConfig: GatsbyConfig = {
  ...
  }, 'gatsby-plugin-react-helmet', 'gatsby-plugin-lodash', {
    options: {
      name: 'assets',
  ...
  }, 'gatsby-transformer-sharp', 'gatsby-plugin-image', 'gatsby-remark-images', {
    options: {
      extensions: ['.md', '.mdx'],
      gatsbyRemarkPlugins: [{
        options: {
  ...
  }, 'gatsby-plugin-catch-links', 'gatsby-plugin-twitter', 'gatsby-plugin-sitemap', {
    options: {
